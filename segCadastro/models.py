...
class Pessoa_Juridica(Estabelecimento):
    ...
    CNPJ = models.CharField(max_length=14, unique=True, null=True, blank=True, default=None)
...
class Processo_Tramita_Setor(models.Model):
    ...
    SITUACAO_CHOICES = (
        ...
        ('PENA_APL', 'PENALIDADE APLICADA'),
        ('PENA_APL_SUS_TAC', 'PENALIDADE APLICADA SUSPENSA - TAC'),
        ('PENA_APL_SUS_TC', 'PENALIDADE APLICADA SUSPENSA - TC'),
        ('PENA_APL_SUS_DJ', 'PENALIDADE APLICADA SUSPENSA - DECISÃO JUDICIAL'),
        ('DEF', 'DEFERIDO'),
        ('IND', 'INDEFERIDO'),
        ('ARQ', 'ARQUIVADO'),
        ('OUT', 'OUTROS'),
